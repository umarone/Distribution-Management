...
namespace Accounts.DAL
{
    public class SaleDetailDAL
    {
        ...
        public DataTable GetAllSalesManSaleSummaryDateWise(Int64 IdProject, Int64 BookNo, DateTime dtReport, SqlConnection objConn)
        {
            List<SaleDetailEL> list = new List<SaleDetailEL>();
            DataTable dtSales = new DataTable();
            SqlCommand cmdProductSale = new SqlCommand("[Transactions].[Proc_GetAllSalesManSaleSummaryDateWise]", objConn);
            
            cmdProductSale.CommandType = CommandType.StoredProcedure;
            cmdProductSale.Parameters.Add("@IdProject", SqlDbType.BigInt).Value = IdProject;
            cmdProductSale.Parameters.Add("@BookNo", SqlDbType.BigInt).Value = BookNo;
            cmdProductSale.Parameters.Add("@VDate", SqlDbType.DateTime).Value = dtReport;
            
            SqlDataAdapter da = new SqlDataAdapter(cmdProductSale);
            da.Fill(dtSales);
