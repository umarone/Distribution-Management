...
namespace Accounts.UI
{
    public partial class frmFindProducts : MetroForm
    {
        ...
        private void chkSearchAll_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                chkAllInActiveItems.Checked = false;
        ...
        private void chkAllInActiveItems_CheckedChanged(object sender, EventArgs e)
        {
            if (chkAllInActiveItems.Checked)
            {
                chkSearchAll.Checked = false;
                var manager = new ItemsBLL();
                List<ItemsEL> list = manager.GetAllInActiveItems(Operations.IdProject);
                grdFindItems.DataSource = list;
            }
            else
            {
