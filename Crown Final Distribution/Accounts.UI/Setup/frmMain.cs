...
namespace Accounts.UI
{
    public partial class frmMain : Form
    {
        ...
        frmSalesManSalesSummaryPivot frmSalesSummaryPivot = null;
        ...
        frmProductFocLedger frmproductfocledger;
        ...
        private void rbnBtnAllSalesManSaleSummary_Click(object sender, EventArgs e)
        {
            frmSalesSummaryPivot = new frmSalesManSalesSummaryPivot();
            frmSalesSummaryPivot.MdiParent = this;
            if (Operations.IdRole == Validation.GetSafeLong(EnRoles.CheifExecutive) || Operations.IdRole == Validation.GetSafeLong(EnRoles.Administrator))
            {
                frmSalesSummaryPivot.Show();
            }
            else if (CheckModuleRights(frmSaleReport.Name) != 0)
            {
                frmSalesSummaryPivot.Show();
